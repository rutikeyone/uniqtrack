...
class AppStrings with _$AppStrings {
  ...
  const factory AppStrings.operationNotAllowed() = _$AppOperationNotAllowedString;
  ...
  const factory AppStrings.networkRequestFailed() = _$AppNetworkRequestsFailedString;
  const factory AppStrings.notInternetConnection() = _$AppNotInternetConnectionString;
  ...
  const factory AppStrings.theUserHasBeenSuccessfullyRegistered() = _$AppTheUserHasBeenSuccessfullyRegisteredString;
}