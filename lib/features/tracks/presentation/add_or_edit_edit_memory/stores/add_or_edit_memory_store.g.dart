...
mixin _$AddOrEditMemoryStore on _AddOrEditMemoryStore, Store {
  ...
  late final _$uploadPhotosModeStateAtom = Atom(
      name: '_AddOrEditMemoryStore.uploadPhotosModeState', context: context);

  @override
  UploadPhotosModeState get uploadPhotosModeState {
    _$uploadPhotosModeStateAtom.reportRead();
    return super.uploadPhotosModeState;
  }

  @override
  set uploadPhotosModeState(UploadPhotosModeState value) {
    _$uploadPhotosModeStateAtom.reportWrite(value, super.uploadPhotosModeState,
        () {
      super.uploadPhotosModeState = value;
    });
  }
