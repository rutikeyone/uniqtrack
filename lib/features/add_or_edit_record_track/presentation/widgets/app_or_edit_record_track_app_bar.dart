...
class _AddOrEditRecordTrackAppBar extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      title: store.modeState.when(
        add: () => Text(
          S.of(context).addMemory,
          style: textStyle,
        ),
        edit: () => Text(
          S.of(context).editMemory,
          style: textStyle,
        ),
      ),
      actions: [
          ...
          edit: () {
            return IconButton(
              ...
              icon: SvgPicture.asset(
                ...
                colorFilter: ColorFilter.mode(context.appColorsTheme.secondaryIconColor, BlendMode.srcIn),
              ),
            );
          },
